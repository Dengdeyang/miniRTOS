...
{
	         uint16  *softimer_id;
	volatile uint8   timer_state;
	volatile uint8   timer_runflag;
	volatile uint32  timer_count;
	volatile uint32  timer_reload;
	uint16           timer_priority;
	volatile uint8   timer_mode;
...
typedef uint16  Soft_Timer_Handle;
